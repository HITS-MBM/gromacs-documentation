...
.. mdp:: pull-group1-slice-smooth

   .. mdp-value:: no

      Non-smooth weighting of the atoms in the slice (all atoms get equally
      weighted).

   .. mdp-value:: yes

      Smooth weighting of the atoms in the slice (0.0 at the beginning and
      at the end, 1.0 in the center, smoothly changing between these values).
